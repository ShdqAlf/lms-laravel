...
<div id="main">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    @foreach ($postestPilihanGanda as $index => $pretest)
                                    <tr>
                                        <td>{{ $index + 1 }}</td>
                                        <td>{!! nl2br(e($pretest->soal_postest)) !!}</td>
                                        ...
                                        <td>
                                            ...
                                            <button type="button" class="btn btn-warning btn-sm edit-btn"
                                                ...
                                                data-soal="{!! nl2br(e($pretest->soal_postest )) !!}"
                                            ...
                                            <form action="{{ route('deletepostest', ['id' => $pretest->id, 'type' => 'pilihanGanda']) }}" method="POST" style="display:inline-block;">
                                                @csrf
                                                @method('DELETE')
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    @foreach ($postestUraian as $index => $pretest)
                                    <tr>
                                        <td>{{ $index + 1 }}</td>
                                        <td>{!! nl2br(e($pretest->soal_postest)) !!}</td>
                                        <td>
                                            ...
                                            <form action="{{ route('deletepostest', ['id' => $pretest->id, 'type' => 'uraian']) }}" method="POST" style="display:inline-block;">
                                                @csrf
                                                @method('DELETE')
                                                <button type="submit" class="btn btn-danger btn-sm" onclick="return confirm('Yakin ingin menghapus soal pretest ini?')">Hapus</button>
                                            </form>
    ...
    <div class="modal fade" id="editPilihanGandaModal" tabindex="-1" aria-labelledby="editPilihanGandaModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="{{ route('updatepostest') }}" method="POST" id="editPilihanGandaForm">
                    @csrf
                    @method('PUT')
    ...
    <div class="modal fade" id="editUraianModal" tabindex="-1" aria-labelledby="editUraianModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="{{ route('updatepostest') }}" method="POST" id="editUraianForm">
                    @csrf
                    @method('PUT')
